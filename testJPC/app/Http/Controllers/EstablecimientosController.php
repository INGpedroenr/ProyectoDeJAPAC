...
class EstablecimientosController extends Controller
{
    ...
    public function editar($id)
    {
      ...
      return view('editarestablecimientos', compact('establecimientos'));
    }
    ...
    public function actualizar($id, Request $datos)
    {
      ...
      return redirect('adminlte::establecimientos');
    }
    ...
    public function pdf()
    {
      ...
      $vista=view('establecimientosPDF', compact('establecimientos'));
